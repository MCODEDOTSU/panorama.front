...
export const state: GeoGeometryState = {
    geometry: {
        id: 0,
        geom: '',
        title: '',
...
export const actions: ActionTree<GeoGeometryState, RootState> = {
...
export const geoGeometry: Module<GeoGeometryState, RootState> = {
    state, actions,
};
