...
export const state: GeoElementState = {
    element: {
        id: 0,
        title: '',
        description: '',
...
export const actions: ActionTree<GeoElementState, RootState> = {
    ...
    async setElementById({rootState, dispatch}, payload) {
        try {
            const res = await axios.put(
                `${baseUrlAPI}geo/element/${payload.elementId}`,
                {
...
export const geoElement: Module<GeoElementState, RootState> = {
    state, actions,
};
