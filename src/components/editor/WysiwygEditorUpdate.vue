<template>
    ...
    <div class="modal fade" id="wysiwygEditorModalUpdate" tabindex="-1" role="dialog"
         aria-labelledby="chosenModulesModalLabel" ref="vuemodal">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="wysiwygEditorModalUpdateLabel">Редактор</h4>
                </div>
