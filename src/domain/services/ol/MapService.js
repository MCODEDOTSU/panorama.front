 ...
 * @param selector
 */
export const initOLMap = (longitude, latitude, zoom, selector) => {
 ...
 * @param action
 */
export const createOLSelectInteraction = (action) => {
 ...
 * @param styles
 */
export const updateOLFeaturesStyle = (layer, styles) => {
...
export const createOLDraw = (mode, layer, action) => {
    if (mode === '') {
        return;
    }
 ...
 * @param feature
 */
export const focusOfFeature = (map, feature) => {
 ...
 * @param features
 */
export const focusOLFeatures = (map, features) => {
